...
public class InteractableTerminalManager : MonoBehaviour
{
    private static InteractableTerminalManager _instance;
    public static InteractableTerminalManager instance { get { return _instance; } }
